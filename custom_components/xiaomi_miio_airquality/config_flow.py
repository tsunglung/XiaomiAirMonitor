"""Config flow to configure Xiaomi Mi/QingPing Air Quality Monitor component."""
...
class XiaomiAirQualityFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle a Xiaomi Mi/QingPing Air Quality Monitor config flow."""
